      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-8">
            <Link href="/hesabat-admin/dashboard" className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="hidden lg:flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-border text-xs font-medium text-muted-foreground hover:border-amber-600 hover:text-amber-600 transition-colors"
            >
                ...
                <div className="p-4 border-b">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Elmi-texniki hesabat admin</p>
                    </div>
                  </div>
                </div>
